...
<div class="card shadow-sm">
    <div class="card-body">
        <h1 class="mb-4">{{ __('app.edit_hotel') }}</h1>
        <form method="POST" action="{{ route('admin.hotels.update', $hotel) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="slug" class="form-control" value="{{ old('slug', $hotel->slug) }}" required>
                </div>
                <div class="col-md-6">
            ...
            <button type="submit" class="btn btn-success mt-4">{{ __('app.update') }}</button>
        </form>
    </div>
</div>
@endsection
